 ...
 * 
 */
package org.ofbiz.mia.recommender.ch05;
...
public class LibimsetiRecommender implements Recommender {
  ...
  public LibimsetiRecommender() throws TasteException, IOException {
    this(new FileDataModel(readResourceToTempFile("specialpurpose/recommender/data/mia/ratings.dat")));
  }
  ...
  public LibimsetiRecommender(DataModel model)
    ...
    this.model = model;
    FastIDSet[] menWomen = GenderRescorer.parseMenWomen(readResourceToTempFile("specialpurpose/recommender/data/mia/gender.dat"));
    men = menWomen[0];
    women = menWomen[1];
