package org.ofbiz.accounting.thirdparty.tenpay;
...
public class TenpayEvents {
    ...
    public static String callTenpay(HttpServletRequest request, HttpServletResponse response) {
    ...
    public static String callbackTenpay(HttpServletRequest request, HttpServletResponse response) {
        Locale locale = UtilHttp.getLocale(request);
        Delegator delegator = (Delegator) request.getAttribute("delegator");
    ...
    public static String cancelTenpayOrder(HttpServletRequest request, HttpServletResponse response) {
        Locale locale = UtilHttp.getLocale(request);
        LocalDispatcher dispatcher = (LocalDispatcher) request.getAttribute("dispatcher");
        GenericValue userLogin = (GenericValue) request.getSession().getAttribute("userLogin");
